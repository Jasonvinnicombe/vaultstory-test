...
const envSchema = z.object({
  ...
  STRIPE_LIFETIME_PRICE_ID_AUD: z.string().min(1).optional(),
  STRIPE_LIFETIME_PRICE_ID_USD: z.string().min(1).optional(),
  STRIPE_LIFETIME_PRICE_ID_GBP: z.string().min(1).optional(),
  STRIPE_LIFETIME_PRICE_ID_EUR: z.string().min(1).optional(),
...
function loadEnv() {
  ...
  cachedEnv = envSchema.parse({
    ...
    STRIPE_LIFETIME_PRICE_ID: normalizeEnvValue(process.env.STRIPE_LIFETIME_PRICE_ID),
    STRIPE_LIFETIME_PRICE_ID_AUD: normalizeEnvValue(process.env.STRIPE_LIFETIME_PRICE_ID_AUD),
    STRIPE_LIFETIME_PRICE_ID_USD: normalizeEnvValue(process.env.STRIPE_LIFETIME_PRICE_ID_USD),
    STRIPE_LIFETIME_PRICE_ID_GBP: normalizeEnvValue(process.env.STRIPE_LIFETIME_PRICE_ID_GBP),
    STRIPE_LIFETIME_PRICE_ID_EUR: normalizeEnvValue(process.env.STRIPE_LIFETIME_PRICE_ID_EUR),
