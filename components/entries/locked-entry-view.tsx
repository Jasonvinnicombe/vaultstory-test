...
export function LockedEntryView(props: { title: string; createdAt: string; unlockAt: string | null; milestoneLabel: string | null; canCompleteMilestone: boolean; milestoneForm?: React.ReactNode; adminPreviewHref?: string; adminPreviewLabel?: string }) {
  return (
