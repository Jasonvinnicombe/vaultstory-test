...
const publicRoutes = [
  ...
  { path: "/family-memory-vault", priority: 0.82 },
  { path: "/digital-time-capsule", priority: 0.82 },
  { path: "/legacy-messages", priority: 0.8 },
  { path: "/future-messages-for-family", priority: 0.8 },
  { path: "/voice-messages-for-loved-ones", priority: 0.78 },
