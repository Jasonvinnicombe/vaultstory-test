      ...
      <div className="section-stack">
        <Card className="overflow-hidden border-white/60 bg-card/88 shadow-[0_28px_84px_rgba(66,46,31,0.12)]">
          <CardContent className="space-y-4 p-8 sm:p-10">
            <div className="h-5 w-32 rounded-full bg-secondary/40" />
            <div className="h-12 w-1/2 rounded-[20px] bg-secondary/30" />
            <div className="h-5 w-2/3 rounded-full bg-secondary/20" />
          </CardContent>
        </Card>
