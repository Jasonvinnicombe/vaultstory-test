...
export const metadata: Metadata = {
  title: "Mobile login | Vault Story",
  robots: {
    index: false,
    follow: false,
  },
    ...
    <main className="flex min-h-screen items-center justify-center bg-[#fbf6f0] px-6 py-10">
      <div className="w-full max-w-md rounded-[28px] border border-[#e6d5c8] bg-[#fffaf5] p-6 shadow-[0_18px_48px_rgba(66,46,31,0.08)] sm:p-8">
        <div className="space-y-3">
          ...
          <h1 className="text-3xl font-semibold text-[#4e2f21]">Mobile sign in</h1>
          <p className="text-sm leading-7 text-[#7a675b]">
            A lighter sign-in screen for the native app so it can start reliably on mobile.
          </p>
        </div>

        <div className="mt-6">
          <MobileAuthForm mode="login" />
        </div>
      </div>
    </main>
  );
